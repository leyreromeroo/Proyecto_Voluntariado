...
CREATE TABLE CURSO_ACADEMICO (
    ...
    CONSTRAINT PK_CURSO_ACADEMICO PRIMARY KEY (CURSO),
    CONSTRAINT CHK_FORMATO_CURSO CHECK (
        CURSO LIKE '[0-9][0-9][0-9][0-9]/[0-9][0-9][0-9][0-9]' AND
        RIGHT(CURSO, 4) - LEFT(CURSO, 4) = 1
    )
);
...
CREATE TABLE ACTIVIDAD (
	...
	CONSTRAINT FK_ACTIVIDAD_CURSO FOREIGN KEY (CURSO_ACADEMICO) REFERENCES CURSO_ACADEMICO (CURSO),
);
...
-- CURSO ACADEMICO
INSERT INTO CURSO_ACADEMICO (CURSO) VALUES 
('2023/2024'),
('2024/2025');
